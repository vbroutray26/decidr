  ...
  return (
    <div style={{ padding: "22px 22px 34px", display: "flex", flexDirection: "column", gap: 18, maxWidth: 640, margin: "0 auto" }} className="rise">
      ...
      <div style={{ borderRadius: 16, overflow: "hidden", border: "1px solid var(--gray-700)" }}>
        ...
        <div style={{ padding: "22px 20px", background: "var(--d-surface-2)", display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            <span style={{ fontSize: 19, fontWeight: 600, lineHeight: 1.35, letterSpacing: "-.01em" }}>
              Singapore offer vs waiting for the promotion
            </span>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            <span style={{ fontSize: 10, fontWeight: 600, letterSpacing: ".1em", textTransform: "uppercase", color: "var(--gray-300)" }}>Leaning</span>
            <span style={{ fontSize: 15, fontWeight: 400, lineHeight: 1.5, color: "var(--gray-50)" }}>
              Take it — after getting the promotion decision in writing.
            </span>
          </div>
          ...
          <div style={{ display: "flex", gap: 16, paddingTop: 14, borderTop: "1px solid var(--d-hairline-2)" }}>
            <span style={{ display: "flex", flexDirection: "column", gap: 2 }}>
              <span style={{ fontSize: 10, color: "var(--gray-300)" }}>Stakes</span>
              <span style={{ fontSize: 13, fontWeight: 600 }}>High</span>
            </span>
            <span style={{ display: "flex", flexDirection: "column", gap: 2 }}>
              <span style={{ fontSize: 10, color: "var(--gray-300)" }}>Door</span>
              <span style={{ fontSize: 13, fontWeight: 600 }}>Two-way</span>
            </span>
            <span style={{ display: "flex", flexDirection: "column", gap: 2 }}>
              <span style={{ fontSize: 10, color: "var(--gray-300)" }}>Revisit</span>
              <span style={{ fontSize: 13, fontWeight: 600 }}>4 weeks</span>
            </span>
          </div>
        </div>
      </div>
      ...
      <div style={{ display: "flex", gap: 10 }}>
        <button onClick={() => navigate("/history")} style={ctaStyle}>
          Save to history
        </button>
